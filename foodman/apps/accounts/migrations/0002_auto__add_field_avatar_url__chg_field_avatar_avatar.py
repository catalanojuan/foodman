...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Avatar.url'
        db.add_column('accounts_avatar', 'url',
                      self.gf('django.db.models.fields.URLField')(max_length=500, null=True, blank=True),
                      keep_default=False)


        # Changing field 'Avatar.avatar'
        db.alter_column('accounts_avatar', 'avatar', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True))

    def backwards(self, orm):
        # Deleting field 'Avatar.url'
        db.delete_column('accounts_avatar', 'url')
